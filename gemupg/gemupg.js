...
var ASM_CONSTS = {
  ...
  1073996: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  1074055: ($0, $1, $2, $3, $4, $5, $6) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  1078006: () => Module["SDL3"].audioContext.sampleRate,
  1078057: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  1092290: () => window.innerWidth,
  1092320: () => window.innerHeight,
  1092351: $0 => {
